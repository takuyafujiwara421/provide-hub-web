...
/* ==========================================================================
 * タスク（MTG ToDo台帳）の状態は**ここで初期化する**。2026-09-21
 * ★なぜファイルの先頭に置くのか
 *   init は 1092行目の即時関数で、読み込みの途中で走る。
 *   その init → loadAll → todoLoad が TODO を触るので、
 *   `var TODO = {...}` をファイルの後ろに書くと**まだ代入されていない**。
 *   実際に「TODO.loading が読めない」で例外になり、init がそこで止まって
 ...
 * ========================================================================== */
/* TODO / TODO_WHO の実体はファイル先頭（init より前）に移した。2026-09-21
   理由はそちらのコメントを見ること。ここに置くと init に間に合わない。 */
